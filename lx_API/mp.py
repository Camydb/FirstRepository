...
@author: amy
"""
token = 't-g205436CIKJXOL6UDAKNM65OHFIUSWILNHRPXN7G'
...
# cur.execute('''DELETE FROM GL_NEWS WHERE CONCAT_WS('', KW_ZH, GT_ZH, TH_ZH,ZH_CN,T_ZH) like "%中国%" ''')
cur.execute('''DELETE FROM GL_NEWS WHERE CONCAT_WS('', KEY_WORD, GPT3_TITLE, THEME,GPT3_TEXT,TITLE) like "%China%" ''')
db.commit()
...
DELETE FROM mytable WHERE CONCAT_WS('', col1, col2, col3, col4) LIKE '%中国%' OR CONCAT_WS('', col1, col2, col3, col4) LIKE '%China%';
...
# example usage
english_string = "Hello, how are you?"
chinese_string = "你好，你好吗？"

print(is_chinese(english_string))  # False
print(is_chinese(chinese_string))  # True
